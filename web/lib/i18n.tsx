...
const en: Dict = {
  ...
  "indexers.desc":
    "Gateway-owned registry stored in MySQL. Each row is one kvindexer backend the gateway can federate.",
...
const zh: Dict = {
  ...
  "indexers.desc":
    "由 kvgateway 管理并存入 MySQL 的连接注册表。每一行都是一个可被网关访问的 kvindexer 后端。",
